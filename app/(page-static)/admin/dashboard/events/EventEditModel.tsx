...
// const EventEditModel: React.FC<CreateEventFormProps> = ({ onSuccess }) => {
//     const {
//         register,
//         handleSubmit,
//         reset,
//         formState: { errors, isSubmitting },
//     } = useForm<CreateEventFormInputs>({handleValue});

//     const handleSave = async (data: CreateEventFormInputs) => {
//         try {
//             const res = await axios.put<CreateEventResponse>("/api/create-event/[id]", data, {
