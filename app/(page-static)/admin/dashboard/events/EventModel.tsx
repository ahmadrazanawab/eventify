...
// interface CreateEventFormProps {
//     onSuccess: () => void; // callback to refresh event list or close modal
// }
...
//     const onSubmit = async (data: CreateEventFormInputs) => {
//         try {
//             const res = await axios.post("/api/create-event/[id]", data); // Your API route
//             if (res.data.success) {
//                 alert("Event created successfully!");
//                 reset();
//                 onSuccess(); // Close modal or refresh events
//             }
//         } catch (err) {
//             console.error(err);
